...
with open('/users/jobber/documents/github/dataprocessing/problem5/homework/d3line/data.json', 'w') as g:
    with open('/users/jobber/documents/github/dataprocessing/problem5/homework/d3line/tempdatasets.csv') as f:
